...
export { useGeofencing } from '../composables/useGeofencing';
export { useImageUpload } from '../composables/useImageUpload';
export { useOfflineSync } from '../composables/useOfflineSync';
...
export { usePDVStore } from '../stores/pdv';
export { useVisitesStore } from '../stores/visites';
