<template>
  <div class="pb-20">
    <div class="p-4">
      <h2 class="text-lg font-bold text-gray-900 mb-4">Calendrier de visites</h2>

      <!-- Month nav -->
      <div class="flex items-center justify-between bg-white rounded-xl p-3 shadow-sm mb-4">
        ...
        <div class="grid grid-cols-7 text-center">
          ...
          >
            ...
            <div
              ...
              :class="day.count >= 5 ? 'bg-green-500' : day.count >= 3 ? 'bg-fc-blue' : 'bg-orange-400'"
            />
          </div>
        </div>
      </div>
      ...
      <div class="mt-6 space-y-3">
        ...
        >
          <div class="flex items-center justify-between">
            <span class="font-medium text-sm text-gray-900">{{ v.pdv?.nom_pdv || v.pdv_id }}</span>
