...
const ELEMENTS_BY_SEGMENT: Record<VisibilitySegment, ElementSeed[]> = {
  boutique: [
    ...
    ['wobler', 'Wobler', 'interieure'],
    ['presentoir', 'Présentoir', 'interieure'],
    ['tg', 'Tête de gondole', 'interieure'],
  ...
  superette: [
    ...
    ['fleche', 'Flèche entrée/sortie', 'exterieure'],
    ...
    ['wobler', 'Wobler rayon', 'interieure'],
    ['presentoir', 'Présentoir', 'interieure'],
    ['tg', 'Tête de gondole', 'interieure'],
    ['plaque_br', 'Plaque BR', 'interieure', true],
    ['merchandising', 'Merchandising', 'interieure'],
  ...
  pushcart: [
    ...
    ['verre_jetable', 'Verre jetable', 'interieure'],
